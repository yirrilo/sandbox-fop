...
public class FopSandboxApp3 {
	...
	public static void main(String[] args) {
		FopSandboxApp3 fOPPdfDemo = new FopSandboxApp3();
		try {
	...
	public void convertToFO() throws IOException, FOPException, TransformerException {
		// the XSL FO file
		File xsltFile = new File(RESOURCES_DIR + "//attestation.xsl");
		...
		// the XML file which provides the input
		StreamSource xmlSource = new StreamSource(new File(RESOURCES_DIR + "//personne.xml"));
		...
		out = new java.io.FileOutputStream(OUTPUT_DIR + "attestation.fo");
