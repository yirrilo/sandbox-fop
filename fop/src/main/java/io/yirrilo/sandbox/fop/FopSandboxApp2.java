...
public class FopSandboxApp2 {
	public static void main(String[] args) throws SAXException, IOException, TransformerException {
		...
		// FileOutputStreams).
		OutputStream out = new BufferedOutputStream(new FileOutputStream(new File("./src/main/resources/attestation.pdf")));
		...
		try {
			...
			// Setup input stream
			Source src = new StreamSource(new File("./src/main/resources/attestation.fo"));
